...
def EliminarAlbum():
    ...
    for album in listado:
        print(' ',album[0],"\t",album[1],"\t\t",album[2]+' '+album[3],"\t\t  ",album[4],"\t",album[5]," $",album[6]," Cant:",album[7]," ",album[8])
    input("Presione ENTER para continuar")
    cod_album = int(input("\nIngrese el codigo del album a borrar: "))
...
def modificar_album():
    ...
    for album in listado:
        print(' ',album[0],"\t",album[1],"\t\t",album[2]+' '+album[3],"\t\t  ",album[4],"\t",album[5]," $",album[6]," Cant:",album[7]," ",album[8])
    input("Presione ENTER para continuar")
    cod_album = int(input("\nIngrese el codigo del album que quiera modificar: "))
    con.modificar_album(cod_album)
    con.conexion.close()


def InsertarAlbum():
    cod_album = int(input("\Inserte el codigo del nuevo Álbum:"))
    nombre = input("Ingrese el nombre del álbum: ")
